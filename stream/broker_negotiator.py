...
class BrokerNegotiator(automat.Automat):
    ...
    def doRequestPrevBroker(self, *args, **kwargs):
        ...
        if target_pos < 0:
            target_pos = 0
        broker_idurl = self.dht_brokers[target_pos]
        if _Debug:
    ...
    def doAccept(self, event, *args, **kwargs):
        ...
        self.result_defer.callback(event, cooperated_brokers=self.cooperated_brokers)
    ...
    def _on_prev_broker_connected(self, response_info, broker_pos, *args, **kwargs):
        ...
        self.automat('prev-broker-accepted')
    ...
    def _on_prev_broker_hired(self, response_info, broker_pos, *args, **kwargs):
        ...
        try:
            ...
            cooperated_brokers = jsn.loads(strng.to_text(response_info[0].Payload)[8:])
        except:
            lg.exc()
